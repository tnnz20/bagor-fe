  ...
  <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <svg class="text-muted-foreground h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            ...
            stroke-width="2"
            d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m9 5.197v1z"
          />
        </svg>
      </CardHeader>
      <CardContent>
        <div class="text-2xl font-bold">1,234</div>
        <p class="text-muted-foreground text-xs">+2.5% from last month</p>
      </CardContent>
    </Card>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <p class="text-muted-foreground text-xs">+12.3% from last month</p>
      </CardContent>
    </Card>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <p class="text-muted-foreground text-xs">+0.2 from last month</p>
      </CardContent>
    </Card>
  </div>
</template>
