...
import DirectorDataDropdown from '../components/DirectorDataDropdown.vue';

import type { NominationDetail } from '@/types/ranking';

export const ShortlistColumns: ColumnDef<NominationDetail>[] = [
  {
...

  {
    ...
    cell: ({ row }) => {
      const employee = row.original;
      return h('div', { class: 'relative' }, h(DirectorDataDropdown, { employee }));
    },
  },
];
