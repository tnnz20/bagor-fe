    ...
    <div class="relative container mx-auto pt-32 pb-8">
      ...
      >
        ...
        <Avatar
          ...
          :key="index"
          class="relative -mr-5 overflow-hidden rounded-full border md:size-10"
        >
      ...
      <div class="relative mt-12 flex h-full w-full flex-col items-center justify-center p-8">
        ...
        <!-- Gradient Overlay -->
        <div class="absolute bottom-0 h-2/3 w-full from-white to-transparent" />
      </div>
    </div>
  </section>
</template>
